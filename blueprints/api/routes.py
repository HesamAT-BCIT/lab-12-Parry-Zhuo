...
def api_get_profile(uid: str):
    ...
    logger.info("Profile fetch requested", extra={"method": "GET", "path": "/api/profile", "uid": uid})
    profile_data = get_profile_data(uid)
    logger.info("Profile fetch successful", extra={"method": "GET", "path": "/api/profile", "uid": uid, "status_code": 200})
...
def api_create_profile(uid: str):
    ...
    if error:
        logger.warning("Profile validation failed", extra={"method": "POST", "path": "/api/profile", "uid": uid, "error": error, "status_code": 400})
        return jsonify({"error": error}), 400

    normalized = normalize_profile_data(first_name, last_name, student_id)
    set_profile(uid, normalized, merge=False)
    logger.info("Profile created successfully", extra={"method": "POST", "path": "/api/profile", "uid": uid, "status_code": 200})
...
def api_update_profile(uid: str):
    ...
    data = request.get_json(silent=True) or {}
    if not data:
        logger.warning("Empty request body for profile update", extra={"method": "PUT", "path": "/api/profile", "uid": uid, "status_code": 400})
...
def api_delete_profile(uid: str):
    ...
    logger.info("Profile deletion requested", extra={"method": "DELETE", "path": "/api/profile", "uid": uid})
    get_profile_doc_ref(uid).delete()
    logger.info("Profile deleted successfully", extra={"method": "DELETE", "path": "/api/profile", "uid": uid, "status_code": 200})
...
def api_get_sensor_data(uid: str):
    ...
    logger.info("Sensor data fetch requested", extra={"method": "GET", "path": "/api/sensor_data", "uid": uid})
    _ = uid
    ...
    try:
        with data_file.open("r", encoding="utf-8") as f:
            data = json.load(f)
        logger.info("Sensor data fetch successful", extra={"method": "GET", "path": "/api/sensor_data", "uid": uid, "status_code": 200})
        return jsonify(data), 200
    except FileNotFoundError:
        logger.error("Sensor data file not found", extra={"method": "GET", "path": "/api/sensor_data", "uid": uid, "error": "File not found", "status_code": 404})
        return jsonify({"error": "mock_sensor_data.json not found"}), 404
    except json.JSONDecodeError as e:
        logger.error("Sensor data file invalid JSON", extra={"method": "GET", "path": "/api/sensor_data", "uid": uid, "error": str(e), "status_code": 500})
...
def api_sensor_data():
    ...
    logger.info("Sensor data upload requested", extra={"method": "POST", "path": "/api/sensor_data"})
    content_error = require_json_content_type()
    if content_error:
        return content_error
    ...
    if not data:
        logger.warning("Empty sensor data received", extra={"method": "POST", "path": "/api/sensor_data", "status_code": 400})
        return jsonify({"error": "Request body cannot be empty"}), 400
    ...
    logger.info("Sensor data stored successfully", extra={"method": "POST", "path": "/api/sensor_data", "status_code": 201})
